...
class Detector:
    ...
    def detectInBetweenFrames(self, startFrame, endFrame, step):
        for frame in range(startFrame+step, endFrame, step):
    ...
    def detect(self):
        ...
        for interval in intervals:
            self.detectInBetweenFrames(interval[0]-15, interval[1] + 15, 5)
